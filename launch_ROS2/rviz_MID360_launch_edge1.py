...
cmdline_bd_code = 'livox47MDN550030317'

cur_path = os.path.split(os.path.realpath(__file__))[0] + '/'
cur_config_path = cur_path + '../config'
rviz_config_path = os.path.join(cur_config_path, 'display_point_cloud_ROS2_edge1.rviz')
user_config_path = os.path.join(cur_config_path, 'MID360_config_edge1.json')
